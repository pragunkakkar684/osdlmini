 ...
 * InvoiceExporter uses FileWriter(path) — creates/overwrites the file each
 * time.
 *
 * 2. PrintWriter — provides convenient println() and printf() for formatted
 * text.
...
public class LogManager {
    ...
    public synchronized void log(String level, String message) {
        ...
        // Auto-flush is disabled here — PrintWriter closes and flushes at end of try
        // block
